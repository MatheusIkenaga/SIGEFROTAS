 ...
 */
public class ConsultaCtsReceber extends javax.swing.JFrame {
    ContaReceberDAO dao = new ContaReceberDAO();
    VeiculoDAO veicDao = new VeiculoDAO();
    /**
     * Creates new form ConsultaCtsReceber
     */
    public ConsultaCtsReceber() {
        initComponents();        
        AddRowToJTable();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Consulta de Contas a Receber");
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        ContaReceber contaAlterar = new ContaReceber();
        ...
        contaAlterar.setTOTAL_RECEBIDO(Float.parseFloat(model.getValueAt(linhaSelecionadaIndex,2).toString()));
        contaAlterar.setSTATUS_CONTA(model.getValueAt(linhaSelecionadaIndex,3).toString());
        contaAlterar.setDT_RECEBIDO(model.getValueAt(linhaSelecionadaIndex,4).toString());
        ...
        new CadastroCtsReceber(contaAlterar);
        this.dispose();
        // TODO add your handling code here:
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        if(botaoDialogo == JOptionPane.YES_OPTION){
            ...
            ContaReceber contaExcluir = new ContaReceber();
            ...
            contaExcluir.setTOTAL_RECEBIDO(Float.parseFloat(model.getValueAt(linhaSelecionadaIndex,2).toString()));
            contaExcluir.setSTATUS_CONTA(model.getValueAt(linhaSelecionadaIndex,3).toString());
            contaExcluir.setDT_RECEBIDO(model.getValueAt(linhaSelecionadaIndex,4).toString());
