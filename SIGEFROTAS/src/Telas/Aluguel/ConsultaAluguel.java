...
import Banco.Aluguel.Aluguel;
import Banco.Aluguel.AluguelDAO;
...
public void AddRowToJTable(){
        ...
        List<Aluguel> list = dao.selectConsulta();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Consulta de Locações");
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        Aluguel viagemalterar = new Aluguel();
        ...
        viagemalterar.setCD_MOTORISTA_VIAGEM(Integer.parseInt(dao.selectAluguel(viagemalterar.getCD_VIAGEM(),"CD_MOTORISTA_VIAGEM")));
        viagemalterar.setCD_VEICULO_VIAGEM(Integer.parseInt(dao.selectAluguel(viagemalterar.getCD_VIAGEM(),"CD_VEICULO_VIAGEM")));
        ...
        new CadastroAluguel(viagemalterar);
        this.dispose();
        // TODO add your handling code here:
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        if(botaoDialogo == JOptionPane.YES_OPTION){
            ...
            Aluguel viagemexcluir = new Aluguel();

            viagemexcluir.setCD_VIAGEM(Integer.parseInt(model.getValueAt(linhaSelecionadaIndex,0).toString()));
            viagemexcluir.setCD_MOTORISTA_VIAGEM(Integer.parseInt(dao.selectAluguel(viagemexcluir.getCD_VIAGEM(),"CD_MOTORISTA_VIAGEM")));
            viagemexcluir.setCD_VEICULO_VIAGEM(Integer.parseInt(dao.selectAluguel(viagemexcluir.getCD_VIAGEM(),"CD_VEICULO_VIAGEM")));
