 ...
 * @author Matheus
 */
public class AlugVeicSinistroDAO {
    
    private Connection conexao;
    
    public AlugVeicSinistroDAO () {
        
        this.conexao = new ConnectionFactory().getConnection("root", "root1234");
    
    }
    
    public void insert(AlugVeicSinistroDAO sinistro){
        String sql = "insert into alug_veic_sinistro (CD_SINISTRO, CD_VEICULO_SINISTRO, CD_MOTORISTA_SINISTRO, CD_SEGURO_SINISTRO)";
