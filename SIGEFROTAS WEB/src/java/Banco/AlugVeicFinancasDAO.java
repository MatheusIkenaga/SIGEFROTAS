 ...
 * @author Matheus
 */
public class AlugVeicFinancasDAO {
    
    private Connection conexao;
    
    public AlugVeicFinancasDAO () {
        
        this.conexao = new ConnectionFactory().getConnection("root", "root1234");
    
    }
    
        public void insert(AlugVeicFinancasDAO financas){
        String sql = "insert into alug_veic_financas (CD_FINANCA, VALOR_MULTA, VALOR_MANUTE, VALOR_VIAGEM, CD_SEGURO_FINANCA, CD_PECA_FINANCA, CD_VIAGEM_FINANCA, CD_MANUTE_FINANCA, CD_MULTA_FINANCA)";
