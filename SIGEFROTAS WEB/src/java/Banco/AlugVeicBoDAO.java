 ...
 * @author Matheus
 */
public class AlugVeicBoDAO {
    
    private Connection conexao;
    
    public AlugVeicBoDAO () {
        
        this.conexao = new ConnectionFactory().getConnection("root", "root1234");
    
    }
    
    public void insert(AlugVeicBoDAO bo){
        String sql = "insert into alug_veic_bo (CD_BO, CD_VEICULO_BO, CD_MOTORISTA_BO, EST_BO, CIDADE_BO)";
