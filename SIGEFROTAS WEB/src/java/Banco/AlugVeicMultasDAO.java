 ...
 * @author Matheus
 */
public class AlugVeicMultasDAO {
    
private Connection conexao;
    
    public AlugVeicMultasDAO () {
        
        this.conexao = new ConnectionFactory().getConnection("root", "root1234");
    
    }
    
    public void insert(AlugVeicMultasDAO multas){
        String sql = "insert into alug_veic_multas (CD_MULTA, CD_VEICULO_MULTA, CD_MOTORISTA_MULTA, DT_MULTA, LOCAL_MULTA, VALOR_MULTA)";
