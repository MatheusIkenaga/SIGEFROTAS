 ...
 * @author Matheus
 */
public class GerFrotaManuteDAO {
    
private Connection conexao;
    
    public GerFrotaManuteDAO () {
        
        this.conexao = new ConnectionFactory().getConnection("root", "root1234");
    
    }
    
    public void insert(GerFrotaManuteDAO manute){
        String sql = "insert into ger_frota_manute (CD_MANUTE, CD_VEICULO_MANUTE, TP_MANUTE, VALOR_MANUTE)";
